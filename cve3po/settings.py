"""
Django settings for cve3po project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "DEFAULT_FOR_BUILD_CHANGE_ME")
...
INSTALLED_APPS = [
    ...
    "vuln_manager.apps.VulnManagerConfig",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "vuln_manager.context_processors.agent_module_context",
            ],
        },
    },
]

WSGI_APPLICATION = "cve3po.wsgi.application"
