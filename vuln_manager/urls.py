...
urlpatterns = [
    ...
    path(
        ...
        auth_views.PasswordResetView.as_view(
            template_name="vuln_manager/auth/password_reset_form.html",
            email_template_name="vuln_manager/auth/password_reset_email.txt",
            subject_template_name="vuln_manager/auth/password_reset_subject.txt",
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name="vuln_manager/auth/password_reset_done.html"
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name="vuln_manager/auth/password_reset_confirm.html",
    ...
    path(
        ...
        auth_views.PasswordResetCompleteView.as_view(
            template_name="vuln_manager/auth/password_reset_complete.html"
        ),
