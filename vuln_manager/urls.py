...
urlpatterns = [
    ...
    path('hosts/<int:pk>/criticality/', views.update_host_criticality, name='update_host_criticality'),
    path('vulnerabilities/', views.vuln_list, name='vuln_list'),
    path('vulnerabilities/<int:pk>/', views.vuln_detail, name='vuln_detail'),
    path('vulnerabilities/<int:pk>/delete/', views.delete_vulnerability, name='delete_vulnerability'),
    path('vulnerabilities/<int:pk>/status/', views.update_vuln_status, name='update_vuln_status'),
    path('api/vulnerabilities/<int:pk>/status/', views.api_update_vuln_status, name='api_update_vuln_status'),
    ...
    path('software/<int:pk>/criticality/', views.update_software_criticality, name='update_software_criticality'),
    path('software/<int:software_pk>/remove-host/<int:host_pk>/', views.remove_host_from_software, name='remove_host_from_software'),
]
